...
return(
    ...
    <div className="flex  flex-col md:py-7 border-b-2 border-boxwind lg:flex-row p-2 md:mx-[29px] lg:mx-7">
   ...
   <form className="md:hidden block pt-4">
     ...
     <div className=" relative" >
      <img className="md:h-[490px] h-[579px] md:pt-4 pt-4 md:w-[893px]" src="image/rain.png"/>
       <div className="absolute flex flex-col gap-6 top-0 p-4 text-white  w-full" >
        <div className="flex md:pt-0 pt-4 flex-row justify-between">
        <p>today 9:41am</p> 
     ...
     <div className=" h-[627px]px-2 md:mx-0 lg:px-4 mt-6 md:mt-0 md:w-full lg:w-[435px]">
        ...
        <div className="der ">
          <p className="">RAIN</p>
          <p  className="text-xl">Expect rain and scattered</p>
          <p className="text-xl">thunderstorm by 12pm</p>
        ...
        <p>RAIN</p>
          <p className="text-xl">expect rain and scattered</p>
          <p className="text-xl">thunderstorm by 12:00pm</p>
          <p  className="text-sm text-range3 pt-2">View more info</p>
    ...
    <div className="">
      ...
      <p className="font-bold text-xl">Saved location</p>
        ...
        <div>
           <button className="px-5 py-2 border-2 border-range3"> + Add city</button>
        </div>
        </div>
    </div>
